<form id="form" action="<?= $form_act ?>" method="post" autocomplete="off">
  <div class="card-body">
    <div class="mb-1 row">
      <label class="col-lg-3 col-md-6 col-form-label required">Pendidikan Id</label>
      <div class="col-lg-4">
        <input type="text" name="pendidikan_id" class="form-control" value="<?= @$main['pendidikan_id'] ?>" required>
      </div>
    </div>
    <div class="mb-1 row">
      <label class="col-lg-3 col-md-6 col-form-label required">Pendidikan</label>
      <div class="col-lg-8 col-md-6">
        <input type="text" name="pendidikan_nm" class="form-control" value="<?= @$main['pendidikan_nm'] ?>" required>
      </div>
    </div>
    <div class="mb-1 row">
