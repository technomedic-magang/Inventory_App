<form id="form" action="<?= $form_act ?>" method="post" autocomplete="off">
    <div class="modal-body">
        <div class="mb-3 row">
            <label class="col-lg-3 col-md-6 col-form-label required">Kode Kategori</label>
            <div class="col-lg-8 col-md-6">
                <input type="text" name="kategori_kd" class="form-control" value="<?= @$main['kategori_kd'] ?>" required placeholder="Contoh: ATK">
            </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="mb-1 row">
            ...
            <div class="col-lg-8 col-md-6">
                <label class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="active_st" value="1" <?= (@$main == '' || @$main['active_st'] == 1) ? 'checked' : '' ?>>
