...
class Master_gudang extends MY_Controller
{
    public function __construct()
    {
        parent::__construct();
        _models(['master/m_master_gudang']);
        $this->table = $this->m_master_gudang->table;
        $this->pk_id = $this->m_master_gudang->pk_id;
        $this->template = 'master/master_gudang/';
    }
    ...
    public function form_modal($id = null)
    {
        ...
        if ($id == null) {
            $d['main']['gudang_kd'] = $this->m_master_gudang->get_next_kode_gudang();
        }
    ...
    public function save($id = null)
    {
        ...
        if ($id == null) {
            ...
            if (empty($d['gudang_kd'])) {
                $d['gudang_kd'] = $this->m_master_gudang->get_next_kode_gudang();
            }
            $d['deleted_st'] = 0;
    ...
    public function ajax_datatables() { $this->m_master_gudang->load_datatables(); }
}