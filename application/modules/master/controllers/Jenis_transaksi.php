...
class Jenis_transaksi extends MY_Controller
{
  public function __construct()
  {
    parent::__construct();
    // @model
    _models(['master/m_jenis_transaksi']);
    // @table
    $this->table = $this->m_jenis_transaksi->table;
    $this->pk_id = $this->m_jenis_transaksi->pk_id;
    // @params
    $this->template = 'master/jenis_transaksi/';
  }
  ...
  {
    $this->m_jenis_transaksi->load_datatables();
  }
}
