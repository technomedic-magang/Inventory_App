        ...
        <div class="container-xl">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title"><?= $this->title ?? 'Asset Masuk' ?></h2>
                </div>
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="javascript:void(0)" onclick="_modal(event, {uri: '<?= $this->uri . '/form_modal' ?>', size: 'modal-xl'})" class="btn btn-primary d-sm-inline-block">
