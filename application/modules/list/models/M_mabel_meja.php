...
class M_mabel_meja extends CI_Model
{
    ...
    {
        // Query disesuaikan untuk mengambil data aset dengan kategori Meja
        $query = "
            SELECT 
                a.asset_id,
                a.asset_kd,
                ...
                -- Ambil Atribut Kustom dari tabel value
            ...
            -- JOIN Atribut Kustom: Tgl Pembelian
        ...
        // Kolom yang bisa dicari via search box datatable
    ...
    // Fungsi untuk mengambil detail atribut kustom saat modal dibuka
