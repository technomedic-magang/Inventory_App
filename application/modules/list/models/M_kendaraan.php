...
class M_kendaraan extends CI_Model
{
    ...
    {
        // [FIX] Header JSON untuk mencegah error parsing di Datatables
        if (ob_get_length()) ob_clean(); 
        header('Content-Type: application/json');

        // Query Utama
        // Menggunakan COALESCE agar jika data NULL tetap muncul strip (-)
        $query = "
            SELECT 
                a.asset_id,
                a.asset_kd,
                ...
                -- Penanggungjawab (Prioritas: Peminjam -> Kepala Gudang)
            ...
            -- Join Lokasi / Peminjam (Cek Pemakaian OPEN)
