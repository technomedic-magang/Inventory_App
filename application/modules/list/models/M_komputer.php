...
class M_komputer extends CI_Model
{
    ...
    public function load_datatables()
    {
        ...
        $query = "
            SELECT 
                ...
                -- [BARU] Tambahkan Tahun & Bulan Beli
                a.asset_thn_beli,
                a.asset_bln_beli,
            ...
            -- [FILTER KHUSUS] Komputer (KP) tapi bukan Printer/Proyektor
    ...
    public function get_detail_kustom($asset_id)
    {
        return $this->db->select('v.value_isi, attr.atribut_label')
                        ...
                        ->order_by('attr.atribut_urutan', 'ASC') // Urutkan biar rapi
                        ->get()->result_array();
    }
}