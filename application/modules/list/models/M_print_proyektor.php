...
class M_print_proyektor extends CI_Model
{
    ...
    public function load_datatables()
    {
        ...
        $search = ['a.asset_kd', 'a.asset_nm', 'v_merek.value_isi', 'pg.pegawai_nm', 'g.gudang_nm', 'tp.transaksi_ket'];
        $isWhere = null;
