                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            ...
                            $bg = ($kondisi == 'BAIK' || $kondisi == 'Baru') ? 'success' : (($kondisi == 'RUSAK' || $kondisi == 'Rusak Berat') ? 'danger' : 'warning');
                        ?>
...
<div class="modal-footer bg-light">
    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</Lanjut>