  ...
  $(document).ready(function() {
    tabel = $('#datatable-main').DataTable({
      ...
      "columns": [
        ...
        // 4. Merek/Seri/Spesifikasi (Dari Atribut Kustom)
        ...
        { 
            ...
            "render": function(data, type, row) {
                ...
                var qrString = `${d.asset_kd}@${d.asset_nm}@${d.merek_seri_spek}@${d.lokasi}@${d.penanggungjawab}`;
