...
<div class="modal-body">
    ...
    <div class="d-flex align-items-center mb-3">
        <div class="me-3">
            <span class="avatar avatar-lg rounded bg-purple-lt">
    ...
    <div class="row">
        <div class="col-md-6 border-end">
            <h4 class="text-muted text-uppercase small font-weight-bold mb-3">Data Umum</h4>
                ...
                <table class="table table-sm table-striped">
                    ...
                    <tr>
                        ...
                        <td class="fw-bold text-dark">
                            <?php 
                                // Format tanggal jika labelnya tanggal
                                if(stripos($row['atribut_label'], 'tanggal') !== false && !empty($row['value_isi'])) {
