...
class Perabot extends MY_Controller
{
    // Konfigurasi Path Standar
    protected $view_path = 'list/list_perabot/';
    protected $uri_path  = 'list/perabot';

    public function __construct()
    {
        parent::__construct();
        _models(['list/m_perabot']); 
        
        $this->model = $this->m_perabot;
