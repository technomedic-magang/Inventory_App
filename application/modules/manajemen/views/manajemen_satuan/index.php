    ...
    <div class="container-xl">
      <div class="row align-items-center">
        <div class="col">
          ...
          <h2 class="page-title">
            <?= $this->title ?? 'Manajemen Satuan' ?>
          </h2>
        </div>
        <div class="col-auto ms-auto d-print-none">
          <div class="btn-list">
            <a href="javascript:void(0)" onclick="_modal(event, {uri: '<?= $this->uri . '/form_modal' ?>', size: 'modal-md', position: 'normal'})" class="btn btn-primary d-sm-inline-block">
