...
{
    public $table = 'trx_kembali';
    public $pk_id = 'kembali_id';
    ...
    public function load_datatables()
    {
        ...
        // [FIX] Pastikan parameter ke-4 null
        $isWhere = null;
    ...
    // Ambil Detail Item dengan Info Lengkap (Atribut)
    public function get_items_pemakaian_list($pemakaian_id)
    {
        ...
        // 3. Join Atribut (Helper internal logic)
    ...
    public function simpan_pengembalian($data_header, $data_detail)
    {
            ...
            if ($qty_kembali > 0) {
                ...
                if ($kondisi_saat_kembali != 'BAIK') {
                    ...
                    $this->db->insert('log_asset_kondisi', [
                        ...
                        'transaksi_ket' => 'Rusak saat pengembalian (Auto System)',
        ...
        // 3. Cek apakah Pemakaian sudah LUNAS?
