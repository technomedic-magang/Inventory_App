  ...
  <div class="card-body">
    ...
    <div class="mb-1 row">
      ...
      <div class="col-lg-8 col-md-6">
        <select name="pemakaian_id" id="pemakaian_id" class="form-select select2-modal" required onchange="loadItems()">
    ...
    <div class="mb-1 row">
      ...
      <div class="col-lg-8 col-md-6">
        <select name="pemakaian_detail_id" id="item_select" class="form-select select2-modal" required disabled onchange="fillItemData()">
