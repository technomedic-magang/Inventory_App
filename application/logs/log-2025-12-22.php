...
ERROR - 2025-12-22 11:09:35 --> Severity: Compile Error --> Cannot redeclare Asset_masuk::get_no_transaksi_ajax() C:\laragon\www\tmfw-main\application\modules\asset\controllers\Asset_masuk.php 174
ERROR - 2025-12-22 13:15:01 --> Query error: Unknown column 'tgl_jatuh_tempo' in 'field list' - Invalid query: 
            SELECT 
                a.asset_id,
                a.asset_kd,
                a.asset_nm,
...
ERROR - 2025-12-22 13:15:15 --> Query error: Unknown column 'tgl_jatuh_tempo' in 'field list' - Invalid query: 
            SELECT 
                a.asset_id,
                a.asset_kd,
                a.asset_nm,
            ...
            LEFT JOIN (SELECT asset_id, MAX(tgl_jatuh_tempo) as max_tgl FROM trx_pajak WHERE deleted_st = 0 GROUP BY asset_id) tp_latest ON a.asset_id = tp_latest.asset_id
         WHERE 1 = 1  AND a.deleted_st='0' AND (LOWER(a.asset_kd) LIKE '%%' OR LOWER(a.asset_nm) LIKE '%%' OR LOWER(v_nopol.value_isi) LIKE '%%' OR LOWER(pg.pegawai_nm) LIKE '%%' OR LOWER(a.asset_thn_beli) LIKE '%%')  ORDER BY asset_kd asc LIMIT 25 OFFSET 0
ERROR - 2025-12-22 13:23:54 --> Query error: Unknown column 'tgl_jatuh_tempo' in 'field list' - Invalid query: 
            SELECT 
                a.asset_id,
                a.asset_kd,
                a.asset_nm,
            ...
            LEFT JOIN (SELECT asset_id, MAX(tgl_jatuh_tempo) as max_tgl FROM trx_pajak WHERE deleted_st = 0 GROUP BY asset_id) tp_latest ON a.asset_id = tp_latest.asset_id
         WHERE 1 = 1  AND a.deleted_st='0' AND (LOWER(a.asset_kd) LIKE '%%' OR LOWER(a.asset_nm) LIKE '%%' OR LOWER(v_nopol.value_isi) LIKE '%%' OR LOWER(pg.pegawai_nm) LIKE '%%' OR LOWER(a.asset_thn_beli) LIKE '%%')  ORDER BY asset_kd asc LIMIT 25 OFFSET 0
ERROR - 2025-12-22 14:59:43 --> Severity: Warning --> A non-numeric value encountered C:\laragon\www\tmfw-main\application\modules\laporan\controllers\Pajak.php 128
ERROR - 2025-12-22 15:00:40 --> Severity: Warning --> A non-numeric value encountered C:\laragon\www\tmfw-main\application\modules\laporan\controllers\Pajak.php 128
ERROR - 2025-12-22 15:59:37 --> Query error: Column 'transaksi_tgl' cannot be null - Invalid query: INSERT INTO `trx_pemakaian` (`transaksi_no`, `transaksi_tgl`, `kembali_rencana_tgl`, `pegawai_id`, `transaksi_ket`, `pemakaian_sts`, `active_st`, `deleted_st`, `created_by`) VALUES ('PMK/197001/0001', NULL, NULL, '000000000029', 'dipakai', 'OPEN', 1, 0, 'P000000000000')
